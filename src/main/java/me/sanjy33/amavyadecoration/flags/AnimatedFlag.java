...
public class AnimatedFlag {
    ...
    public boolean hasFlagPole() {
        return !flagpoleOffset.isZero();
    }
    ...
    private void constructMaterialArray() {
        ...
        this.materials = new Material[xMax-xMin][height];
        for (int x = xMin; x < xMax; x++)  {
            for (int y = yMin; y < yMax; y++) {
                int _x = x - xMin;
                int _y = y - yMin;
                ...
                this.materials[_x][_y] = block.getType();
